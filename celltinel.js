document.addEventListener("DOMContentLoaded", () => {
	...
	const basePath = "celltinel_anim/png_0";
	const numberOfImages = 22; //change depending on the video
	const imagePaths = [];

	const renderingWidth = 130.208;
	const renderingHeight = 115.741;
	...
	function renderFrame(frameIndex) {
		...
		img.onload = function () {
			...
			const xOffset = (canvas.width - renderingWidthRES) / 2;
